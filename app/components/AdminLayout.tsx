    ...
    const notificationMenu = {
        items: [
                ...
                label: (
                    <div className="py-1 max-w-xs">
                        ...
                        <div className="text-sm font-medium">
                            Đơn BK-202609-8802 (Đà Lạt Pine Hill) đang chờ xác
                            nhận
                        </div>
            ...
            },
            {
                ...
                label: (
                    <div className="py-1 max-w-xs">
                        ...
                        <div className="text-sm font-medium">
                            Lê Hoàng Nam đã đăng ký tài khoản mới
                        </div>
                        <div className="text-xs text-gray-400">
                            45 phút trước
                        </div>
            ...
            },
            {
                ...
                label: (
                    <div className="py-1 max-w-xs">
                        <div className="font-semibold text-xs text-amber-600">
                            ĐÁNH GIÁ MỚI
                        </div>
                        <div className="text-sm font-medium">
                            Furama Resort Đà Nẵng vừa nhận đánh giá 5 sao
                        </div>
                ...
                <Header className="sticky top-0 z-10 px-6 h-16 w-full flex items-center justify-between border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xs transition-colors">
                    ...
                    <div className="flex items-center gap-4">
                        <Input
                            ...
                            className="w-56 hidden sm:flex rounded-full bg-slate-50/80 dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-xs text-slate-800 dark:text-slate-100 placeholder:text-slate-400"
                        />
                            ...
                            <Button
                                ...
                                icon={
                                    isDarkMode ? (
                                        ...
                                        <MoonOutlined className="text-slate-600 dark:text-slate-300" />
                                    )
                                }
                        ...
                        >
                            <Badge count={3} size="small" offset={[-2, 2]}>
                                <Button
                                    ...
                                    shape="circle"
                                    icon={
                                        <BellOutlined className="text-slate-600 dark:text-slate-300" />
                                    }
                                />
                            </Badge>
                        </Dropdown>
                        ...
                        <Dropdown menu={userMenu} placement="bottomRight">
                            <div className="flex items-center gap-2.5 cursor-pointer pl-2 hover:opacity-85 transition-opacity">
                                <Avatar
                                    ...
                                    className="border border-slate-200 dark:border-slate-700 shadow-2xs w-8 h-8"
                                />
                                <div className="hidden md:flex flex-col text-left">
                                    <Text
                                        strong
                                        className="text-xs leading-tight text-slate-800 dark:text-slate-100 font-semibold"
                                    >
