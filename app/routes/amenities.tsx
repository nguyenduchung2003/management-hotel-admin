        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white dark:bg-slate-900 p-5 rounded-2xl shadow-xs border border-slate-200/60 dark:border-slate-800">
                <div>
                    ...
                    >
                        Danh mục các dịch vụ, tiện nghi phòng ở, giải trí dùng
                        chung cho Khách sạn & Homestay.
                    </Text>
                </div>
                <Button
                    type="primary"
                ...
                <Row gutter={[16, 16]}>
                    {filteredAmenities.map((item) => (
                        <Col xs={24} sm={12} md={8} lg={6} key={item.id}>
                            <Card
                                className="card-hover-effect border-none shadow-xs rounded-xl h-full bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800"
                                actions={[
                                    <Button
                                        type="text"
                                        icon={
            ...
            <Modal
                title={
                    editingAmenity
                        ? `Sửa tiện ích: ${editingAmenity.label}`
                        : "Thêm Tiện Ích / Dịch Vụ Mới"
                }
                open={isModalOpen}
            ...
            >
                ...
                >
                    ...
                    <Form.Item name="icon" label="Biểu tượng Icon">
                        <Select>
                            <Option value="WifiOutlined">
                                Wi-Fi (WifiOutlined)
                            </Option>
                            <Option value="CarOutlined">
                                Bãi đỗ xe (CarOutlined)
                            </Option>
                            <Option value="SkinOutlined">
                                Bể bơi (SkinOutlined)
                            </Option>
                            <Option value="CoffeeOutlined">
                                Ăn sáng (CoffeeOutlined)
                            </Option>
                            <Option value="ControlOutlined">
                                Điều hòa (ControlOutlined)
                            </Option>
                            <Option value="FireOutlined">
                                Bếp / BBQ (FireOutlined)
                            </Option>
                            <Option value="SyncOutlined">
                                Máy giặt (SyncOutlined)
                            </Option>
                            <Option value="HeartOutlined">
                                Thú cưng (HeartOutlined)
                            </Option>
                            <Option value="CustomerServiceOutlined">
                                Lễ tân 24/7 (CustomerServiceOutlined)
                            </Option>
                        </Select>
                    </Form.Item>
                </Form>
